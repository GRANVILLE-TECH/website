...
export default function Hero() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black">
      ...
      {/* Top Header - Merged with brand name */}
          ...
          <div className="max-w-lg relative">
            ...
            <div className="relative">
              <p className="text-xs lg:text-base text-gray-300 mb-5 lg:mb-6 leading-relaxed font-mono opacity-80">
                Pioneering transformative AI solutions that redefine industries and empower a smarter tomorrow.
              </p>
            ...
            <div className="hidden lg:flex items-center gap-2 mt-6 opacity-40">
              ...
              <div className="flex-1 h-px bg-white"></div>
              <span className="text-white text-[9px] font-mono">INTELLIGENCE</span>
            </div>
          </div>
        </div>
      </div>
